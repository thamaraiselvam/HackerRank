...
describe('HackerRank in a String', () => {
	...
	describe('should return YES inputs containing hackerrank', () => {
		it('hereiamstackerrank', () => expect(hackerrankInString('hereiamstackerrank')).to.equal('YES'));
		it('hhaacckkekraraannk', () => expect(hackerrankInString('hhaacckkekraraannk')).to.equal('YES'));
	});
	describe("should return NO for inputs that don't contain hackerrank", () => {
		it('hackerworld', () => expect(hackerrankInString('hackerworld')).to.equal('NO'));
		it('rhbaasdndfsdskgbfefdbrsdfhuyatrjtcrtyytktjjt', () => expect(
